...
from policies import average_reward_from_rollouts, get_random_agent, sr_from_rollouts, sa_sr_from_rollouts, p_s_from_rollouts, p_sa_from_rollouts, collect_rollouts
...
def compute_l1_from_run(base_args, adv_args, run):
    ...
    for i, epoch in enumerate(run):
        ...
        adv_policy.learn_policy(learn_env, base_args["env_T"], adv_args["online_epochs"], reward_fn, **adv_args["learning_args"] )
